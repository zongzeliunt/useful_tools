...
#CUDA:
PATH=$PATH:~/Tool/ROOT/bin:/usr/local/cuda-10.1/bin
#LLVM:
PATH=$PATH:/home/ares/LLVM/build/bin
#OCAML:
PATH=$PATH:/home/ares/.opam/system/bin
export LD_LIBRARY_PATH=/usr/systemc/lib-linux64:/usr/local/cuda-10.1/lib64
